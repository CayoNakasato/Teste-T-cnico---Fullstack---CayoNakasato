...
export default function ContactModal({ open, handleModal, contact }) {

  const {updateContact, setCanSeeContacts, canSeeContacts} = useContext(ContactDataContext);
    ...
    <Modal open={open} onClose={handleModal}>
      <Box sx={modalStyle}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className={style.container}>
          ...
          <button type="submit" className={style.btn_register_contact}>
            Salvar
          </button>
        </form>
      </Box>
